/**
 * Shared SVG icon registry. All icons use a 24×24 viewBox with
 * stroke-based rendering (width 1.8-1.9, rounded caps/joins).
 *
 * Used by: header links, trust bar, hero trust pills, gallery captions,
 * admin icon dropdowns.
 *
 * Each value is the inner SVG path data — wrap in:
 *   <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
 *        stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round">
 *     <path d={icons[name]} />
 *   </svg>
 *
 * Icons with multiple paths use the full element markup (path + circle, etc.)
 * and should be rendered with {@html}.
 */
...
/** Sorted icon names for admin dropdowns. */
